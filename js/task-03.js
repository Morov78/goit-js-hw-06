...
listGalleryEl.style.listStyleType = "none";
const listStringOfTags = images.map(
  ({ url: src, alt }) => `<li> <img src="${src}" alt="${alt}"> </li>`
);
const stringTags = listStringOfTags.reduce((total, string) => total + string);
listGalleryEl.insertAdjacentHTML("afterbegin", stringTags);
